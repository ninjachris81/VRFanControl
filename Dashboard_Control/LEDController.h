...
private:
  const CRGB colors[COLOR_COUNT] = {LED_COLOR_0, LED_COLOR_1, LED_COLOR_2, LED_COLOR_3, LED_COLOR_4, LED_COLOR_5, LED_COLOR_6, LED_COLOR_7, LED_COLOR_8};
  ...
  const uint8_t ledCounts[LED_STRIP_COUNT] = {LED_COUNT_DASHBOARD, LED_COUNT_FINS, LED_COUNT_CABLE_HOLDER, LED_COUNT_MIDDLE_STRIP, LED_COUNT_HEADLIGHTS_LEFT, LED_COUNT_HEADLIGHTS_RIGHT, LED_COUNT_HEADLIGHTS_AMB_LEFT, LED_COUNT_HEADLIGHTS_AMB_RIGHT };
  uint8_t ledDefaultColors[LED_STRIP_COUNT] = {1, 1, 1, 1, 4, 4, 4, 4};
