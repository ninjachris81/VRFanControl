...
//  #define PIN_COMM_TX 24
  ...
  #define PIN_LED_CABLE_HOLDER 11
  #define PIN_LED_MIDDLE_STRIP 7
  #define PIN_LED_HEADLIGHTS_LEFT 12
  #define PIN_LED_HEADLIGHTS_RIGHT 13
  #define PIN_LED_HEADLIGHTS_AMB_LEFT 3
  #define PIN_LED_HEADLIGHTS_AMB_RIGHT 4
